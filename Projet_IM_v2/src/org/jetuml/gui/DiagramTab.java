...
public class DiagramTab extends Tab implements MouseDraggedGestureHandler, KeyEventHandler
{
	...
	public static String myVar="khaaaawi";
...
//		aDiagramCanvas.paste();
	...
	public void setTitle()
	{
		if(aFile.isPresent())
		{
			...
			try {
                // write the value of title to the file
...
//	public Object generXML() throws IOException {
//		 
//		Alert alert = new Alert(AlertType.INFORMATION, RESOURCES.getString("Generate XML Document Successfully "), ButtonType.OK);
//		alert.initOwner(aMainStage);
//		alert.setHeaderText(RESOURCES.getString("XML FILE"));
//		alert.showAndWait();
//		ProcessBuilder pb = new ProcessBuilder("java", "JDOM1");
//		pb.directory(new File("G:/Study/S2/5-Ingénierie.Modèles/Mini-Projet/MiniProjet/JetUML-master/src/org/jetuml/JDOM1"));
//		Process p = pb.start();
////		JDOM1 dom = new JDOM1();
