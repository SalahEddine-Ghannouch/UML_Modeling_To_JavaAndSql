...
public final class FileExtensions
{
	...
	private static final ExtensionFilter FILTER_XML =
	        new ExtensionFilter(RESOURCES.getString("application.file.xml"), "*" + EXTENSION_XML);
	...
	public static List<ExtensionFilter> all()
	{
		...
		result.add(FILTER_XML); // add the new XML filter here
